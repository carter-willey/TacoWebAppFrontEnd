...
const Home = (props) => {
  const {currentUser, currentToken, usersFeed, allShops, getTacosFromShopByShopId, tacosFromShop, getUserFromDb, setWasTacoPosted} = props
  return ( 
      ...
      <div className="row mainRow">
        ...
        <div className="col middle "> 
            <CreatePost allShops={allShops} currentToken={currentToken} currentUser={currentUser}
             getTacosFromShopByShopId={getTacosFromShopByShopId} setWasTacoPosted={setWasTacoPosted}
